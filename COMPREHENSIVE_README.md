...
├── bimanual_graph_rep.py     # 989 lines - Graph structure, edges, attributes
├── bimanual_model.py         # 483 lines - BimanualAGI model
├── bimanual_diffusion.py     # 515 lines - Coupled diffusion training
├── bimanual_dataset.py       # 434 lines - Dataset classes
├── bimanual_train.py         # 212 lines - Training script
...
**File**: `bimanual_graph_rep.py` (989 lines)
...
**File**: `bimanual_model.py` (483 lines)
...
**File**: `bimanual_diffusion.py` (515 lines)
...
**File**: `bimanual_train.py` (212 lines)
...
**File**: `ip/configs/bimanual_config.py`
...
| File                    | Lines | Purpose                                             |
| ----------------------- | ----- | --------------------------------------------------- |
| `bimanual_graph_rep.py` | 989   | Graph structure, node/edge construction, attributes |
| `bimanual_model.py`     | 483   | BimanualAGI model with three-stage transformer      |
| `bimanual_diffusion.py` | 515   | Coupled diffusion training/inference                |
| `bimanual_dataset.py`   | 434   | Dataset classes and collation                       |
| `bimanual_train.py`     | 212   | Training script                                     |
| `generator.py`          | 605   | Pseudo-demonstration generation                     |
| `data_structures.py`    | 241   | BimanualTrajectory, BimanualGraphData, etc.         |
| `objects.py`            | 463   | Procedural object generation                        |

### Pattern Files

| File                                | Lines | Purpose                 |
| ----------------------------------- | ----- | ----------------------- |
| `patterns/coordination_patterns.py` | 443   | Four pattern generators |

### Original IP Files (in `ip/`)

| File                             | Purpose                                  |
| -------------------------------- | ---------------------------------------- |
| `ip/models/graph_rep.py`         | Original single-arm graph representation |
| `ip/models/model.py`             | Original single-arm AGI model            |
| `ip/models/scene_encoder.py`     | PointNet++ scene encoder (shared)        |
| `ip/models/graph_transformer.py` | Graph transformer layer                  |
| `ip/utils/common_utils.py`       | SE(3) utilities, rigid transforms        |
| `ip/utils/normalizer.py`         | Action normalization                     |
| `ip/configs/bimanual_config.py`  | Bimanual configuration                   |
