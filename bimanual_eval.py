...
Usage:
    python bimanual_eval.py --task_name='lift_tray' --num_demos=2 --num_rollouts=10
...
from bimanual_rl_bench_utils import rollout_bimanual_model
from bimanual_rl_bench_tasks import BIMANUAL_TASK_NAMES
