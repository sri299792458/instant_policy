...
from external.ip.utils.normalizer import Normalizer
from external.ip.utils.repairs import repair_checkpoint
from src.models.model import BimanualAGI
...
class BimanualGraphDiffusion(L.LightningModule):
    ...
    def _decode_predictions_to_actions(self, preds: torch.Tensor, 
        ...
        from external.ip.utils.common_utils import get_rigid_transforms
